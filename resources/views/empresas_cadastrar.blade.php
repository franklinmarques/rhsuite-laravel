                        ...
                        @if (auth()->user('empresa') === '78')
                            <fieldset>
                                ...
                                <ul id="tree">
                                    <li>
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <input type="checkbox" name="hash_acesso[PAPD][]"
                                                       value="502">
                                                <i class="fa fa-file text-info"></i> Gestão
                                                Atividades/Deficiências
                                            </li>
                                            <li>
                                                <input type="checkbox" name="hash_acesso[PAPD][]"
                                                       value="503">
                                                <i class="fa fa-file text-info"></i> Relatório
                                                Totalização Mensal
                                            </li>
                                            <li>
                                                <input type="checkbox" name="hash_acesso[PAPD][]"
                                    ...
                                    <li>
                                        <input type="checkbox">
                                        <i class="fa fa-folder-open jstree-warning"></i>&ensp;&ensp;Gestão
                                        Operacional ST
                                        <ul>
                                            <li>
                                                <input type="checkbox" name="hash_acesso[ST][]" value="401">
                                                <i class="fa fa-file text-info"></i> Gestão de
                                                Contratos
                                            </li>
                                            <li>
