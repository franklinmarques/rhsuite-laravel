  ...
  $('form.ajax-simple').submit(function () {
    ...
    $('input.valida, select.valida, textarea.valida', this).each(function () {
      if ($(this).val() === '') {
        ...
        erro = 1;
      } else $(this).css('border-color', '#cccccc');
    });
      ...
      success: function success(data) {
        ...
        if (parseInt(data['retorno'])) {
          aviso.html('<div class="alert alert-success">' + data['aviso'] + '</div>').fadeIn('slow', function () {
            if (parseInt(data['redireciona'])) window.location = data['pagina'];
          });
        } else {
      ...
      complete: function complete(data) {
        ...
        if (parseInt(data['retorno'])) {
          aviso.html('<div class="alert alert-success">' + data['aviso'] + '</div>').hide().fadeIn('slow', function () {
            if (parseInt(data['redireciona'])) top.location.href = data['pagina'];
          });
        } else {
...
(function ($) {
  ...
  $(document).ready(function () {
    ...
    if ($.fn.sparkline) {
      ...
      var sparkLine = function sparkLine() {
    ...
    $('.sidebar-toggle-box:has(.fa-bars)').click(function (e) {
      ...
      $(".leftside-navigation").getNiceScroll().show();
      $('#main-content, .modal, .modal-backdrop').toggleClass('merge-left');
      e.stopPropagation();
    ...
    $('.popovers').popover(); // Modal in wrapper div

    $(document).on('show.bs.modal', '.wrapper .modal', function () {
      setTimeout(function () {
